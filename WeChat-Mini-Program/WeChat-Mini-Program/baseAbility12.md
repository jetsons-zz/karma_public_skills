...
1. 在`app.json`中配置`themeLocation`，指定变量配置文件[theme.json](https://developers.weixin.qq.com/miniprogram/dev/framework/ability/darkmode.html#变量配置文件-theme-json)路径，例如：在根目录下新增`theme.json`，需要配置`"themeLocation":"theme.json"`
...
![darkmode_devtool](https://res.wx.qq.com/wxdoc/dist/assets/img/darkmode_devtool.854be5bb.png)

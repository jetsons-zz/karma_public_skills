...
还有更多计划提供出来的特性，请详见[特性状态](https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/status.html)
...
![img](https://res.wx.qq.com/wxdoc/dist/assets/img/skyline-vs-webview.0052fc0c.png)
...
![img](https://res.wx.qq.com/wxdoc/dist/assets/img/skyline-memory-1.bd17fd77.png)

![img](https://res.wx.qq.com/wxdoc/dist/assets/img/skyline-memory-2.d2e81d47.png)

与内存占用的测量类似，CPU 利用率的测量数据如下图所示（单位 %），也能看出，Skyline 相对 WebView 也有不错的提升。

![img](https://res.wx.qq.com/wxdoc/dist/assets/img/cpu-usage.fbba28e2.png)
...
<video controls="controls" src="https://res.wx.qq.com/op_res/4SPnz2ileNeS1bdLGNIQkRLT8wZnUYHnbp9l8qUntKerMEzxPsSsht6uVDK-nX3LUqT0ACuBerhNCUhawoxAqQ" style="margin: 0px; padding: 0px; -webkit-tap-highlight-color: transparent; width: 720px;"></video>
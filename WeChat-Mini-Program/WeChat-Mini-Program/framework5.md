...
![img](https://res.wx.qq.com/wxdoc/dist/assets/img/interative-model.b746ab92.png)
...
| getBoundingClientRect         | *webview*: 无 *skyline*: (rect: BoundingClientRect) => void | webview 中，返回值与 [SelectorQuery](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.boundingClientRect.html) 的 `boundingClientRect` 一致； skyline 中此调用无法同步返回，会以回调形式异步返回 | [2.14.2](https://developers.weixin.qq.com/miniprogram/dev/framework/compatibility.html) |
